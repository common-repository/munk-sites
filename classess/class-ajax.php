...
class Munk_Sites_Ajax {
    ...
    function ajax_import_options(){
        ...
        if ( $file ) {
            ...
            $this->_import_elementor_template_kit(); // update elementor_active_kit
        }
     ...
     * Import widgets
     */
    function _import_elementor_template_kit() {
        ...
        // find imported template kit and update elementor_active_kit option                
        $args = array(            
		...
		if ( ! empty( $query ) && isset( $query[0] ) ) {                        
			update_option( 'elementor_active_kit', $query[0] );		
        }            
